...
//////////////////////////////////////
// Discribtion: Customized Structural Templete Liberay(STL) Application
// Date : 
...
int main() //Main Entry Point Function of STL
{
    ...
    while(iChoice!=0)
    {
        ...
        printf("\n____________________________\n");
                ...
                case 3: iRet=stlobj.Peek();
                cout<<"Peek Element is:"<<iRet<<"\n";
                break;

                case 4: iRet=stlobj.Count();
        ...
        switch(iSelect)
        {
                ...
                case 3: iRet=saobj.Peek();
                cout<<"Peek Element is:"<<iRet<<"\n";
                break;

                case 4: iRet=saobj.Count();
